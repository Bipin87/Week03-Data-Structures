...
import static com.capgemini.challenge_problem.linear_search_first_missing_positive_integer.FirstMissPosInteger.binarySearch;
...
public class Main {
    public static void main(String[] args) {
        ...
        try(BufferedReader br = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            int missingNumber = searchFirstMissingPositive(list);
            // Display the index
            ...
            System.out.println(binarySearch(list,target) + " index target found");
